...
namespace Components.GPGPU.Layer
{
    public abstract class LayerBase
    {
        ...
        public RNdObject Input { protected get { return AreaList[0].Array; } set { AreaList[0].Array = value; } }
        public RNdObject Output { get { return AreaList[1].Array; } protected set { AreaList[1].Array = value; } }
        public int OutputChannel { get; set; }

        private List<Function.ComputeParameter> area { get; set; }

        private List<Function.ComputeParameter> AreaList { get; set; }
